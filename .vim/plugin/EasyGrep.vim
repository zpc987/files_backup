...
function! s:CreateDirectMappings()
    ...
    nmap <silent> <leader>fya    :call <sid>ActivateAll()<cr>
    nmap <silent> <leader>fyb    :call <sid>ActivateBuffers()<cr>
    nmap <silent> <leader>fyt    :call <sid>ActivateTracked()<cr>
    nmap <silent> <leader>fyu    :call <sid>ActivateUser()<cr>

    nmap <silent> <leader>fc    :call <sid>ToggleCommand()<cr>
    nmap <silent> <leader>fyr    :call <sid>ToggleRecursion()<cr>
    nmap <silent> <leader>fyi    :call <sid>ToggleIgnoreCase()<cr>
    nmap <silent> <leader>fyh    :call <sid>ToggleHidden()<cr>
    nmap <silent> <leader>fyw    :call <sid>ToggleWindow()<cr>
    nmap <silent> <leader>fyo    :call <sid>ToggleOpenWindow()<cr>
    nmap <silent> <leader>fyg    :call <sid>ToggleEveryMatch()<cr>
    nmap <silent> <leader>fyp    :call <sid>ToggleJumpToMatch()<cr>
    nmap <silent> <leader>fy!    :call <sid>ToggleWholeWord()<cr>
    nmap <silent> <leader>fye    :call <sid>EchoFilesSearched()<cr>
    nmap <silent> <leader>fys    :call <sid>Sort()<cr>
    nmap <silent> <leader>fy/    :call <sid>ToggleOptionsDisplay()<cr>
    nmap <silent> <leader>fy?    :call <sid>EchoOptionsSet()<cr>
endfunction
"}}}
" GrepCurrentWord {{{
...
if !hasmapto("<plug>EgMapGrepOptions")
    map <silent> <Leader>fo <plug>EgMapGrepOptions
endif
if !hasmapto("<plug>EgMapGrepCurrentWordv")
    map <silent> <Leader>fv <plug>EgMapGrepCurrentWordv
endif
if !hasmapto("<plug>EgMapGrepCurrentWordV")
    map <silent> <Leader>fV <plug>EgMapGrepCurrentWordV
endif
if !hasmapto("<plug>EgMapGrepCurrentWorda")
    map <silent> <Leader>fa <plug>EgMapGrepCurrentWorda
endif
if !hasmapto("<plug>EgMapGrepCurrentWordA")
    map <silent> <Leader>fA <plug>EgMapGrepCurrentWordA
endif
if !hasmapto("<plug>EgMapReplaceCurrentWordr")
    map <silent> <Leader>fr <plug>EgMapReplaceCurrentWordr
endif
if !hasmapto("<plug>EgMapReplaceCurrentWordR")
    map <silent> <Leader>fR <plug>EgMapReplaceCurrentWordR
endif
